...
NSArray *pointsFromBezierPath(CMKBezierPath *bpath);


#define VALUE(_INDEX_) [NSValue valueWithCGPoint:points[_INDEX_]]
#define POINT(_INDEX_) [(NSValue *)[points objectAtIndex:_INDEX_] CGPointValue]

@implementation CMKBezierPath (Smoothing)
...
- (CMKBezierPath *)smoothedPathWithGranularity:(NSInteger)granularity;
{
    ...
    CMKBezierPath *smoothedPath = [self copy];
...
#pragma mark - generate smoothed Bezier path from CGPoints wrapped in NSValues
